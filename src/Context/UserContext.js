...
export const UserProvider=({children})=>{
    ...
    const UserRegister=(props)=>{
        ...
        axios.post('http://localhost:8000/user/register',props.user)
        .then((res)=>{
    ...
    const UserLogin=(props)=>{
        axios.post('http://localhost:8000/user/login',props.user)
        .then((res)=>{
...
await axios.post('http://localhost:8000/user/getUser',{},{
